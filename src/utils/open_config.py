...
def get_default_params():
    ...
    parser.add_argument('--model', type=str, default=config["files"]["model"], help='Path to save the trained model')
    ...
    parser.add_argument('--copy_X', type=str, default=train_config["hyperparameters"]["copy_X"], help='Whether to copy X for polynomial regression')
    parser.add_argument('--fit_intercept', type=str, default=train_config["hyperparameters"]["fit_intercept"], help='Whether to fit intercept for polynomial regression')
    parser.add_argument('--n_jobs', type=int, default=train_config["hyperparameters"]["n_jobs"], help='Number of jobs to run in parallel')
    parser.add_argument('--positive', type=str, default=train_config["hyperparameters"]["positive"], help='Whether to constrain coefficients to be positive')
    parser.add_argument('--degree', type=int, default=train_config["model_specs"]["degree"], help='Degree of the polynomial regression model')
    parser.add_argument('--model_type', type=str, default=train_config["model_specs"]["model_type"], choices=['Polynomial Regression'], help='Type of model to be used')
